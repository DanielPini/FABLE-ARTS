const artists = [
  {
    ...
    biography: "Spanning art, technology and science, Victoria Pham is an Australian artist, evolutionary biologist, writer and composer. She is based between Paris and Sydney. <br /><br />Originally trained as an archaeologist, she holds a PhD in Biological Anthropology from the University of Cambridge, St John's College. <br /><br />As a composer, she trained under the tutelage of Richard Gill OAM, Liza Lim, Carl Vine AO, Gerard Brophy and Thierry Escaich. <br /><br />Victoria is represented by the Australian Music Centre as an Associate Artist where a collection of her scores are available. <br /><br />Currently, she is the Editor-in-Chief of Debris Magazine, lead artist in the RE:SOUNDING project with James Nguyen, and co-lead artist in the collective SONANT BODIES with James Hazel. <br /><br />She was the host and producer of podcast series DECLASSIFY (2020-2022)  and co-founded and directed FABLE ARTS from (2020-2023).",
  ...
  },
  {
    ...
    biography: "Daniel is an Australian conductor and cellist based between Paris and Sydney. He is also the director of <span class'fa'>FABLE ARTS</span>, which he co-founded in 2020. <br /><br />He is an advocate for authentic contemporary stories, particularly from those whose voices often go unheard. <br /><br />His practice centers around the belief that music, art, and the stories they tell can change hearts and minds.",
  ...
  },
  {
    ...
    biography: "Justin Julian studied with Roger Benedict at the Sydney Conservatorium. He has worked with the Sydney, Melbourne, Adelaide and Canberra Symphony Orchestras and the Opera Australia Orchestra. <br /><br />Justin was a 2017 Emerging Artist with the Australian Chamber Orchestra and completed the 2018 Sydney Symphony Orchestra Fellowship program. <br /><br />Justin has also performed with the Omega Ensemble and was a founding member of the Pietra Quartet and Nautilus Ensemble.",
  ...
  },
  {
    ...
    biography: "Praised by The Guardian for her “irrepressible sense of drama and unmissable, urgent musicality”, Lotte Betts-Dean is a mezzo soprano with a wide ranging repertoire, predominantly performing chamber music, art song and contemporary music. <br /><br />She is a Young Artist with Oxford Lieder, City Music Foundation, Musicians Company, Associate Artist with Southbank Sinfonia and Ensemble x.y, and graduate of the RAM. She won both the Overseas Prize and the Audrey Strange Prize.",
  ...
  },
  {
    ...
    biography: "Sebastian is a current student of the Hochschule für Musik Freiburg, where he learns with Božo Paradžik, after having previously studied with Alex Henery for over a decade. <br /><br />He is a recipient of the International String Prize at Gisborne international Music Competition, winning other events such as the Melbourne Bass Day 2019, and the Edna Wilde award for Most Outstanding Instrumentalist, and he hopes to be able share his love of music and the double bass going forward.",
    website: "",
  ...
  },
  {
    ...
    biography: "Danica Hobden is a graduate and current student of the Sydney Conservatorium, having completed a BMus in Classical Guitar, before continuing her studies with a Bachelor of Jazz Performance. <br /><br />Following a keen interest in language learning, she completed 3 semesters of study at the Hochschule für Künste Bremen in Germany, under the tutelage of Andreas Wahl and Jens Wagner from 2019-2021. <br /><br />Danica is currently working on various personal projects & performing with Celtic Rock band Bread and Seaweed.",
  ...
  },
  {
    ...
    biography: "By day, Jaap works as a researcher in Human Evolutionary Biology. At night he haunts the pubs of Cambridge with the Cambridge University Ceilidh band. <br /><br />Originally from the Netherlands, he is a self-taught guitarist who fell in love with British folk music when he arrived in the UK in 2013.",
  ...
  },
  {
    ...
    biography: "Laura is a lecturer in human evolution at the University of Cambridge, and researches the evolution of the traits that set humans apart from other species. <br /><br />Following in the footsteps of Homo erectus, Laura is a keen visual artist and plays the whistle, in the manner of the Neanderthal musician that played the 60,000-year-old cave bear flute. Her favourite medium, however, is the written word. <br /><br />She has published poetry and short stories (in addition to academic papers).",
  ...
  },
  {
    ...
    biography: "Sonja Schebeck was born in Sydney, Australia and her violin teachers have included Barbara Hayward (Suzuki), Christopher Kimber (Sydney Conservatorium) and Florian Zwiauer (MUK Vienna). <br /><br />She founded ‘The Freestyle Orchestra’ in 2006 and is a founding member of Nigel Kennedy’s ‘Orchestra of Life’. <br /><br />Her masters thesis is in “Innovations in Classical Music Presentation” (MUK Vienna). <br /><br />Sonja is currently touring Europe with Australian circus company ‘Gravity & Other Myths’ as violinist/multi-instrument",
  ...
  },
  {
    ...
    biography: "Dr Natalia Zdorovtsova received a neuroscience PhD from the University of Cambridge. She was born in Saint Petersburg, Russia, but has spent much of her life between the United States and United Kingdom. <br /><br />As a neuroscientist, Natalia is interested in how the brain coordinates attention in our day-to-day lives. Lately, Natalia has been interested in the processes by which we can engage with the concept of the Sacred. In her abstract art series, Symbiosis, she merges her love of art and neuroscience.",
  ...
  },
  {
    ...
    biography: "Christine Pan is a Sydney-based composer who often develops her works from social-cultural and philosophical frameworks that she takes great pride in meticulously researching. <br /><br />Her music has been played by the Goldner Quartet, Ensemble Offspring and members of WASO. <br /><br />In 2022, Christine premiered an audio-visual work at Konzertprojekt’s Sound Stories Concert supported by the City of Sydney and a new chamber work premiered by Corvus at the Fairbanks Summer Festival Alaska.",
  ...
  },
  {
    ...
    biography: "Hamish Upton is a percussionist who thrives as a contemporary music collaborator and educator. <br /><br />He has performed with many of Australia’s leading new music ensembles, including Speak Percussion, most recently in Scream Star featuring premieres by Matthew Shlomowitz, Johannes Kreidler and Jessie Marino. He has worked with James Hullick & the BOLT ensemble, Elision, and was a performer at Bendigo International Festival of Exploratory Music in 2016, 2017 and 2019. <br /><br />Hamish co-directs the award-winning exploratory ensemble Ossicle Duo with trombonist Benjamin Anderson, and the pair have commissioned 6 new works for this unique instrumental combination.",
  ...
  },  
  {
    ...
    biography: "Niki Johnson is a contemporary percussionist and composer-performer whose musical practice incorporates interdisciplinary collaboration and artistic research. <br /><br />She has been commissioned to compose and perform solo percussion works for the Sydney Powerhouse Museum and Art Gallery of New South Wales, and is a current PhD student and teacher at Monash University. <br /><br />As an interdisciplinary collaborator she works with sound designers, musicians, fine artists, and theatre-makers to create instrumental sculptures and performances across the disciplines of music, sculpture, installation and experimental theatre. As a freelancing percussionist she has recorded percussion for the ABC, Sydney Opera House, Phoenix Central Park, and Trackdown Fox studios.",
