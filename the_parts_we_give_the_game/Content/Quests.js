        ...
        steps: [
          ...
          },
          {
            ...
            dialogue: [
              ...
              {
                text: "At the end of the game is an exclusive coupon which you can use to get a commemorative The Parts We Give, the Game sticker when you to go see the Song Cycle.",
                name: "Daniel",
              },
              {
                text: "Just present it to the ticket sellers at the door and they'll take care of it.",
                name: "Daniel",
              },
              {
                text: "Alongside the coupon, you can find a link to book your tickets for the Song Cycle.",
                name: "Christine",
              },
              {
